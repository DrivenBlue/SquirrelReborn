...
bool TitleScene::init()
{
    ...
    //Play button, normal and pressed
    ...
    //	Getting star to move around play button
    ...
    //	auto path = MyPathFun( -50, startItem->getContentSize().height, startItem->getContentSize().width);
